...
import {
	deleteIntegrationAccountAgreement,
	openIntegrationAccountAgreementInEditor,
	viewIntegrationAccountAgreementProperties,
} from "./commands/integration-account/IntegrationAccountAgreementCommands";
import {
	deleteIntegrationAccount,
	viewIntegrationAccountProperties,
} from "./commands/integration-account/integrationAccountCommands";
import {
	deleteIntegrationAccountMap,
	openIntegrationAccountMapInEditor,
	viewIntegrationAccountMapProperties,
} from "./commands/integration-account/integrationAccountMapCommands";
import {
	deleteIntegrationAccountPartner,
	openIntegrationAccountPartnerInEditor,
	viewIntegrationAccountPartnerProperties,
} from "./commands/integration-account/integrationAccountPartnerCommands";
import {
	deleteIntegrationAccountSchema,
	openIntegrationAccountSchemaInEditor,
	viewIntegrationAccountSchemaProperties,
} from "./commands/integration-account/integrationAccountSchemaCommands";
...
export async function activate(
	...
	await callWithTelemetryAndErrorHandling(
		"azureLogicApps.activate",
		async function activateCallback(this: IActionContext): Promise<void> {
			...
			registerCommand(
				"azureLogicApps.addBuildDefinitionToProject",
			...
			registerCommand(
				"azureLogicApps.addLogicAppToProject",
				async (node: IAzureNode) => {
					await addLogicAppToProject(tree, node);
				}
			);

			registerCommand(
				"azureLogicApps.createLogicApp",
				async (node: IAzureParentNode) => {
			...
			registerCommand(
				"azureLogicApps.disableLogicApp",
				async (node: IAzureNode) => {
			...
			registerCommand(
				"azureLogicApps.openRunActionInEditor",
				async (node?: IAzureNode) => {
			...
			registerCommand(
				"azureLogicApps.openRunInEditor",
				async (node?: IAzureNode) => {
			...
			registerCommand(
				"azureLogicApps.openRunInMonitoringView",
				async (node?: IAzureNode) => {
			...
			registerCommand(
				"azureLogicApps.openTriggerInEditor",
				async (node?: IAzureNode) => {
			...
			registerCommand(
				"azureLogicApps.openVersionInDesigner",
				async (node?: IAzureNode) => {
			...
			registerCommand(
				"azureLogicApps.openVersionInEditor",
				async (node?: IAzureNode) => {
			...
			registerEvent(
				...
				async function (
					...
					await logicAppEditor.onDidSaveTextDocument(
						this,
						context.globalState,
						document
					);
	...
	await callWithTelemetryAndErrorHandling(
		"azIntegrationAccounts.activate",
		async function activateCallback(this: IActionContext): Promise<void> {
			this.properties.isActivationEvent = "true";
			...
			registerCommand(
				"azIntegrationAccounts.createIntegrationAccount",
				async (node?: IAzureParentNode) => {
					await createChildNode(
						integrationAccountTree,
						Constants.SubscriptionContextValue,
						node
					);
				}
			);
			...
			registerCommand(
				"azIntegrationAccounts.createAgreement",
				async (node?: IAzureParentNode) => {
			...
			registerCommand(
				"azIntegrationAccounts.createMap",
				async (node?: IAzureParentNode) => {
					const child = await createChildNode(
						integrationAccountTree,
			...
			registerCommand(
				"azIntegrationAccounts.createPartner",
				async (node?: IAzureParentNode) => {
					const child = await createChildNode(
						integrationAccountTree,
			...
			registerCommand(
				"azIntegrationAccounts.createSchema",
				async (node?: IAzureParentNode) => {
					const child = await createChildNode(
						integrationAccountTree,
			...
			registerCommand(
				"azIntegrationAccounts.deleteIntegrationAccount",
				async (node: IAzureNode) => {
			...
			registerCommand(
				"azIntegrationAccounts.deleteAgreement",
				async (node: IAzureNode) => {
					await deleteIntegrationAccountAgreement(
						integrationAccountTree,
						node
					);
				}
			...
			registerCommand(
				"azIntegrationAccounts.deleteMap",
				async (node: IAzureNode) => {
					await deleteIntegrationAccountMap(
						integrationAccountTree,
						node
					);
				}
			...
			registerCommand(
				"azIntegrationAccounts.deletePartner",
				async (node: IAzureNode) => {
					await deleteIntegrationAccountPartner(
						integrationAccountTree,
						node
					);
				}
			...
			registerCommand(
				"azIntegrationAccounts.deleteSchema",
				async (node: IAzureNode) => {
					await deleteIntegrationAccountSchema(
						integrationAccountTree,
						node
					);
				}
			...
			registerEvent(
				"azIntegrationAccounts.integrationAccountAgreementEditor.onDidSaveTextDocument",
				vscode.workspace.onDidSaveTextDocument,
				async function (
					this: IActionContext,
					document: vscode.TextDocument
				): Promise<void> {
					await integrationAccountAgreementEditor.onDidSaveTextDocument(
						this,
						context.globalState,
						document
					);
			...
			registerEvent(
				"azIntegrationAccounts.integrationAccountMapEditor.onDidSaveTextDocument",
				vscode.workspace.onDidSaveTextDocument,
				async function (
					this: IActionContext,
					document: vscode.TextDocument
				): Promise<void> {
					await integrationAccountMapEditor.onDidSaveTextDocument(
						this,
						context.globalState,
						document
					);
			...
			registerEvent(
				"azIntegrationAccounts.integrationAccountPartnerEditor.onDidSaveTextDocument",
				vscode.workspace.onDidSaveTextDocument,
				async function (
					this: IActionContext,
					document: vscode.TextDocument
				): Promise<void> {
					await integrationAccountPartnerEditor.onDidSaveTextDocument(
						this,
						context.globalState,
						document
					);
			...
			registerEvent(
				"azIntegrationAccounts.integrationAccountSchemaEditor.onDidSaveTextDocument",
				vscode.workspace.onDidSaveTextDocument,
				async function (
					this: IActionContext,
					document: vscode.TextDocument
				): Promise<void> {
					await integrationAccountSchemaEditor.onDidSaveTextDocument(
						this,
						context.globalState,
						document
					);
			...
			registerCommand(
				"azIntegrationAccounts.openAgreementInEditor",
				async (node?: IAzureNode) => {
					await openIntegrationAccountAgreementInEditor(
						integrationAccountTree,
						integrationAccountAgreementEditor,
			...
			registerCommand(
				"azIntegrationAccounts.openMapInEditor",
				async (node?: IAzureNode) => {
					await openIntegrationAccountMapInEditor(
						integrationAccountTree,
						integrationAccountMapEditor,
			...
			registerCommand(
				"azIntegrationAccounts.openPartnerInEditor",
				async (node?: IAzureNode) => {
					await openIntegrationAccountPartnerInEditor(
						integrationAccountTree,
						integrationAccountPartnerEditor,
			...
			registerCommand(
				"azIntegrationAccounts.openSchemaInEditor",
				async (node?: IAzureNode) => {
					await openIntegrationAccountSchemaInEditor(
						integrationAccountTree,
						integrationAccountSchemaEditor,
			...
			registerCommand(
				"azIntegrationAccounts.viewAgreementProperties",
				async (node?: IAzureNode) => {
					await viewIntegrationAccountAgreementProperties(
						integrationAccountTree,
						node
					);
				}
			...
			registerCommand(
				"azIntegrationAccounts.viewMapProperties",
				async (node?: IAzureNode) => {
					await viewIntegrationAccountMapProperties(
						integrationAccountTree,
						node
					);
				}
			...
			registerCommand(
				"azIntegrationAccounts.viewPartnerProperties",
				async (node?: IAzureNode) => {
					await viewIntegrationAccountPartnerProperties(
						integrationAccountTree,
						node
					);
				}
			...
			registerCommand(
				"azIntegrationAccounts.viewSchemaProperties",
				async (node?: IAzureNode) => {
					await viewIntegrationAccountSchemaProperties(
						integrationAccountTree,
						node
					);
				}
			...
			registerCommand(
				"azIntegrationAccounts.viewIntegrationAccountProperties",
				async (node?: IAzureNode) => {
					await viewIntegrationAccountProperties(
						integrationAccountTree,
						node
					);
				}
