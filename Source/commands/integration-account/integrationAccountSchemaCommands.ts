...
export async function deleteIntegrationAccountSchema(
...
export async function openIntegrationAccountSchemaInEditor(
	tree: AzureTreeDataProvider,
...
export async function viewIntegrationAccountSchemaProperties(
	tree: AzureTreeDataProvider,
	node?: IAzureNode,
): Promise<void> {
	if (!node) {
